...
class PartialTrack:
    ...
    def __init__(self, query : str, node : lavalink.Node):
        self.query = query
        self.node = node

    async def _search(self):

        return lavalink.AudioTrack((await self.node.get_tracks(f"ytsearch:{self.query}")))
...
class CustomPlayer(lavalink.BasePlayer):
    ...
    def position(self):
        ...
        difference = t.time() * 1000 - self._last_update
